...
echo ""
echo "================================================"
echo "  MATLAB File Reader - Pre-Release Check"
echo "================================================"
echo ""
...
# 9. HDF5 dependency check (MATLAB-specific)
log_info "Checking HDF5 dependency..."
HDF5_VERSION=$(grep "github.com/scigolib/hdf5" go.mod | awk '{print $2}')
if [ -n "$HDF5_VERSION" ]; then
    log_success "HDF5 dependency: $HDF5_VERSION"
else
    log_error "HDF5 dependency not found in go.mod"
    ERRORS=$((ERRORS + 1))
fi
echo ""
